...
btn_frame = ttk.Labelframe(win,text='Label in a Frame')
btn_frame.grid(row=4,column=0)

# Place labels into the container element
ttk.Label(btn_frame,text='Label1').grid(row=0,column=0,sticky=tk.W)
ttk.Label(btn_frame,text='Label2').grid(row=0,column=1,sticky=tk.W)
ttk.Label(btn_frame,text='Label3').grid(row=0,column=2,sticky=tk.W)
